    ...
    if (typeof bookingData == 'number') {
      tableRow.push(<td className="table__cell--available">
          <Link to="/createbooking" onClick={() => {
              props.onSetRoom(props.service._id)
            ...
            <tr>
              <td className={`table__cell`}>
                <span
                  ...
                  className={`table__cell--booked table__cell--${firstBookingData.businessId // Class name will show the business unit that made the booking, and whether the <td> element should be fully shaded, or half shaded (indicating a half-hour booking)
                    .replace(/ /g, '-')
                    .toLowerCase()}
                  `}
                >
              ...
              <td className={`table__cell`}>
                <span
                  ...
                  className={`table__cell--booked table__cell--${secondBookingData.businessId // Class name will show the business unit that made the booking, and whether the <td> element should be fully shaded, or half shaded (indicating a half-hour booking)
                    .replace(/ /g, '-')
                    .toLowerCase()}
                  `}
                >
      ...
      tableRow.push(
        <td className={`table__cell`}>
          <span
            ...
            className={`table__cell--booked table__cell--${bookingData.businessId 
              .replace(/ /g, '-')
              .toLowerCase()}
...
const RoomRow = props => (
  <tr className="table__row">
    <th scope="row" className="table__cell--align-left">
      <Link to="/createbooking" onClick={() => props.onSetService(props.service._id)} className="table__link">{props.service.name}</Link>
      <ul >
      {Object.keys(props.service.assets).map(
        asset =>
