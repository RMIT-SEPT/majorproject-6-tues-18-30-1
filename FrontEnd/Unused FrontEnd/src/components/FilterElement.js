  ...
  return (
    <div className="sidebar__box--filter filter">
      ...
      <form className="form form--filter">
        <h4 className="form__heading form__heading--filter">Nubmer</h4>
        <div className="form__group" onChange={(event) => onSetServiceParam(event.target.value)}>
          <div className="form_group">
            <input type="radio" value="8" name="service-select" className="form__input--radio" checked={serviceParam === '8' ? true : false}/>
            <label for="service8" className="form__label form__label--inline">Number 8</label>
          </div>
          <div className="form_group">
            <input type="radio" value="13" name="service-select" className="form__input--radio" checked={serviceParam === '13' ? true : false}/>
            <label for="service13" className="form__label form__label--inline">Number 13</label>
          </div>
          <div className="form_group">
            <input type="radio" value="all" name="service-select" className="form__input--radio" checked={serviceParam === 'all' ? true : false}/>
            <label for="all" className="form__label form__label--inline">All </label>
          </div>
        </div>
