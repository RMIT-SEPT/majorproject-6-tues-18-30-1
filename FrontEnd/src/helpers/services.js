...
// Accepts the search date in 'YYYY/MM/DD' format of all  bookings and filters the array for bookings that match the search date
const dailyBookings = (currentDate, serviceBookings) => {
...
// A function to take the bookings for a particular service on a given date and insert them into an array which maps each hour of that day
